    ...
    $('#resetPasswordForm').validate(
        {
            ...
            highlight: function (element) {
                ...
                $(element).next().next().html('<object type="image/svg+xml" tabindex="-1" data="/img/ic-message-danger.svg?b=${version}" width="4" height="16">');
            ...
            success: function (element) {
                ...
                $(element).next().html('<object type="image/svg+xml" tabindex="-1" data="/img/ic-message-success.svg?b=${version}" width="16" height="16">');
