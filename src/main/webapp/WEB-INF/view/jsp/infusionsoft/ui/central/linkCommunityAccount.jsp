...
<div id="main">
    ...
    <form id="associateForm" action="associate" method="post">
        ...
        <p>
            Enter the username and password you were using before you created your Infusionsoft ID to link your account.
        </p>
        ...
        <div class="buttonbar">
            <input type="submit" value="Link Account" class="primary"/>
            <a href="${centralUrl}" class="ui-button">Cancel</a>
        </div>
    </form>
</div>
