...
VALUES
    (0, 0, 'Marketplace3', 1, 4100, 1, 'Marketplace 3+', 'https://marketplace3(dev)?\\.infusion(soft|test)\\.com(:[0-9]+)?/.*', 1, NULL, 'regex', 'id'),
...
UPDATE RegisteredServiceImpl SET allowedToProxy = 0 WHERE name in ('InfusionsoftCRM', 'Marketplace3');