 ...
 * @since 3.0.4
 */
public class InfusionsoftSecurityQuestionsAction {
    ...
    public final void doBind(final RequestContext context, final List<SecurityQuestionResponse> securityQuestionResponses) throws Exception {
...
//        }
    ...
    public final String submit(final RequestContext context, final List<SecurityQuestionResponse> securityQuestionResponses, final MessageContext messageContext) throws Exception {
